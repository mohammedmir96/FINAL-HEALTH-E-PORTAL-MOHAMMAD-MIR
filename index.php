...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp GOOD HEALTH</h4></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="contact.html" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>FEEDBACK</h6></a>
          </li>
        </ul>
      </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                      <!--  <img src="https://image.ibb.co/n7oTvU/logo_white.png" alt=""/>-->
						<img src="img/good-health-logo.png" width="800" height="100" alt=""/>
                        <h3>Welcome</h3>
                        <marquee width="80%" direction="up" height="100px"> </marquee>
                       
                       <marquee width="80%" direction="left" height="100px"> </marquee>
                    </div>
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
								...
								&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <a href="forgot3.php">forgot password</a> 
                            </form>
                            </div>
