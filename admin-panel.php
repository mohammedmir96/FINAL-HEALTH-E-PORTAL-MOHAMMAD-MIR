    ...
    if((date("Y-m-d",$appdate1)==$cur_date and date("H:i:s",$apptime1)>$cur_time) or date("Y-m-d",$appdate1)>$cur_date) {
      $check_query = mysqli_query($con,"select apptime from appointmenttb where doctor='$doctor' and appdate='$appdate' and apptime='$apptime'");
        ...
        if(mysqli_num_rows($check_query)==0){
		  ...
		  if($aaptType=="home")
		  {
			$sql2 = "SELECT address FROM `patreg` WHERE email = '$email'"; 
			$res = mysqli_query($con, $sql2);
			$add=$res->fetch_array()[0];
			$sql3 = "SELECT email FROM `doctb` WHERE username='$doctor'";
			$res2=mysqli_query($con, $sql3);
			$mail2=$res2->fetch_array()[0];
			require('phpmailer/class.phpmailer.php');
		require('phpmailer/class.smtp.php');
	
		$message_body = "Name of Patient : " . $fname ." ".$lname."<br/><br/>".
		                "Email : " . $email . "<br/><br/>".
						"Mobile : " .$contact . "<br/><br/>".
						"Address : " .$add;
		$mail = new PHPMailer();
                $mail->AddReplyTo('healthportal2@gmail.com','E-Hospital');
                $mail->SetFrom('healthportal2@gmail.com','E-Hospital');
		  ...
		  //if($aaptType=="hospital")
		  elseif($aaptType=="hospital")
		  {
			$sql2 = "SELECT hosAddress FROM `doctb` WHERE username='$doctor'";
			$res = mysqli_query($con, $sql2);
			$add=$res->fetch_array()[0];
			$sql3 = "SELECT email FROM `patreg` WHERE email = '$email'";
			$res2=mysqli_query($con, $sql3);
			$mail2=$res2->fetch_array()[0];
			require('phpmailer/class.phpmailer.php');
		require('phpmailer/class.smtp.php');
	
		$message_body = "Your Appointment is scheduled :<br/><br/>Address of the Hospital is : " . $add;
		$mail = new PHPMailer();
                $mail->AddReplyTo('healthportal2@gmail.com','E-Hospital');
                $mail->SetFrom('healthportal2@gmail.com','E-Hospital');
                $mail->AddAddress($mail2);
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Good Health</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Good Health </a>
              ...
              document.getElementById('spec').onchange = function updateSpecs(e) {
                ...
                document.getElementById('doctor1').value = document.querySelector(`[value=${values}]`).getAttribute('data-value');
                  ...
                  <div class="col-md-8">
				   ...
				   <div class="col-md-4">
                          <label for="chAppt">Choose Appointment</label>
                        </div>
                        
                  <div class="col-md-8">
                          <select name="chAppt" class="form-control" id="spec">
                              <option value="" disabled selected>Select Appointment Option</option>
							  <option value="home" >Doctor to Visit Home</option>
							  <option value="hospital" >Patient to Visit Hospital</option>
