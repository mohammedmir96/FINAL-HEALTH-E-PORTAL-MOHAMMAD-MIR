<?php
$con=mysqli_connect("localhost","root","","myhmsdb")or die ("Couldnt connect");
...
if(mail($to, $subject, $message, $headers)){
        ...
        echo"</script>"; 
        $sql4="update patreg set password='$password' where email='$mail'";
		$sql5="update patreg set cpassword='$password' where email='$mail'";
...
.form-signin input[type="password"] {
  ...
  border-top-right-radius: 0;
    ...
    <BR>
    <a class="btn btn-lg btn-primary btn-block" href="index1.php">Login</a>
    </form>
</html>